...
const RightComponent = () => {
    return (
        <div className='p-5 bg-night-blue text-light-purple'>
            ...
            {/* Folder Container */}
            <div className='mt-5 bg-dark-gray px-4 rounded'>
                <div className='flex justify-between border-b border-charcoal py-5'>
                    ...
                    <div className='flex gap-5 items-center'>
                        ...
                        <button className='bg-ice-blue text-night-blue px-3 py-2 rounded flex items-center hover:bg-opacity-75'>
            ...
            {/* Cards Container */}
            <div className='cards-container mt-5 grid grid-cols-3 gap-2'>
